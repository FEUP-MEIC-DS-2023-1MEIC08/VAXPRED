...
describe('PluginPageHeaderComponent', () => {
  ...
  it('should display the plugin title', () => {
    ...
    const testPlugin = new Plugin(1, testTitle, 'Test Description', 'Test Path', 'Test Type', ['Tag 1']);
  ...
  it('should display the plugin version tag', () => {
    ...
    const testPlugin = new Plugin(1, 'Test Plugin', 'Test Description', 'Test Path', 'Test Type', ['Tag 1']);
  ...
  it('should display the plugin ID', () => {
    const testID = 42;
    const testPlugin = new Plugin(testID, 'Test Plugin', 'Test Description', 'Test Path', 'Test Type', ['Tag 1']);
